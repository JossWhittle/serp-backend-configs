...
-- || CREATE WDSD TABLE
-- =============================================
CREATE TABLE IF NOT EXISTS WDSD_MAIN (
...
COPY WDSD_MAIN(alf, wob, gndr_cd, lsoa2011_cd)
...
COPY WLGP_REG(alf, start_dt, end_dt)
...
COPY WLGP_EVENT(alf, gndr_cd, wob, event_dt, event_cd)
...
COPY PEDW_EPISODE(spell_num, epi_num, epi_start, epi_end, epi_duration, first_epi_in_spell)
...
COPY PEDW_SPELL(spell_num, gndr_cd, admis_yr, admis_dt, disch_yr, disch_date, spell_duration, alf)
...
COPY PEDW_SUPERSPELL(person_spell_num, provider_spell_num, spell_num, epi_num)
